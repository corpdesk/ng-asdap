...
export class SioClientService {
   ...
   */
  initSio() {
    console.log('ng-asdap-v2::SioClientService::initSio()/01')
    ...
    this.listenSecure('push-msg-relayed')
      .subscribe((payLoadStr: string) => {
        console.log('ng-asdap-v2::SioClientService::initSio()/listenSecure()/push-msg-relayed/:payLoadStr:', payLoadStr)
        if (payLoadStr) {
          const payLoad: ICdPushEnvelop = JSON.parse(payLoadStr)
          console.log('ng-asdap-v2::SioClientService::initSio()/listenSecure(msg-relayed)payLoad:', payLoad)
   ...
   */
    this.listenSecure('push-msg-pushed')
      .subscribe((payLoadStr: string) => {
        console.log('ng-asdap-v2::SioClientService::initSio()/listenSecure()/push-delivered/:payLoadStr:', payLoadStr)
  ...
  public sendMessage(msg: string) {
    console.log('ng-asdap-v2::SioClientService::sendMessage()/msg', msg)
    this.socket.emit('message', msg);
  }

  public sendPayLoad(pushEnvelope: ICdPushEnvelop) {
    console.log('ng-asdap-v2::SioClientService::sendPayLoad/01/pushEnvelope:', pushEnvelope)
    if ('pushData' in pushEnvelope) {
      if ('pushGuid' in pushEnvelope.pushData) {
        console.log('ng-asdap-v2::SioClientService::sendPayLoad/02/pushEnvelope:')
        ...
        console.log('ng-asdap-v2::SioClientService::sendPayLoad/01/triggerEvent missing in payLoad.pushData')
      }
    } else {
      console.log('ng-asdap-v2::SioClientService::sendPayLoad/01/pushData missing in pushEnvelope')
    }

  }

  public listenSecure = (emittEvent: string) => {
    console.log('ng-asdap-v2::SioClientService::listenSecure()/emittEvent/01', emittEvent)
    this.socket.on(emittEvent, (payLoadStr: any) => {
      ...
      if (payLoadStr) {
        console.log('ng-asdap-v2::SioClientService::listenSecure()/emittEvent/01/emittEvent:', emittEvent)
        console.log('ng-asdap-v2::SioClientService::listenSecure()/payLoadStr:', payLoadStr)
        const payLoad: ICdPushEnvelop = payLoadStr;
        if ('pushData' in payLoad) {
          console.log('ng-asdap-v2::SioClientService::listenSecure/2')
          if ('triggerEvent' in payLoad.pushData) {
            console.log('ng-asdap-v2::SioClientService::listenSecure/3')
            triggerEvent = payLoad.pushData.triggerEvent;
          } else {
            console.log('ng-asdap-v2::SioClientService::listenSecure()/triggerEvent missing in payLoad.pushData')
          }
        } else {
          console.log('ng-asdap-v2::SioClientService::listenSecure()/pushData missing in payLoad')
        }
         ...
         *    - 
         */
        console.log('ng-asdap-v2::SioClientService::listenSecure/4')
        ...
        if (emittEvent === 'push-msg-relayed') {
           ...
           */
          console.log('ng-asdap-v2::SioClientService::listenSecure/5')
           ...
           */
          console.log('ng-asdap-v2::SioClientService::listenSecure/6')
          if (emittEvent === 'push-msg-relayed') {
  ...
  notificationAcceptDelivery(payLoad: ICdPushEnvelop) {
    console.log('ng-asdap-v2::SioClientService::notificationAcceptDelivery()/01')
    console.log('ng-asdap-v2::SioClientService::notificationAcceptDelivery()/senderAcceptDelivery:', payLoad)
    /**
  ...
  notificationMsgComplete(payLoad: ICdPushEnvelop) {
    console.log('ng-asdap-v2::SioClientService::notificationMsgComplete()/01')
    console.log('ng-asdap-v2::SioClientService::notificationMsgComplete()/1:', payLoad)
    /**
     * update record of payload
     * - delivered time
     * - delivered = true
    ...
    console.log('ng-asdap-v2::SioClientService::notificationMsgComplete/2:', payLoad)
    /**
     * reverse sender and receiver subTypeId
     */
    this.sendPayLoad(payLoad);
